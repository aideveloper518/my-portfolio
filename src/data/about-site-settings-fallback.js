/** About card keys in site_settings — fallback when Supabase is off or keys missing. */
export const ABOUT_SITE_SETTINGS_FALLBACK = {
  about_intro:
    "Hello! My name is {name}, and I am passionate about creating impactful, innovative digital experiences that live on the internet.",
...
export const ABOUT_STATS_FALLBACK = [
